      ...
      {selectedUsuario && (
        ...
        >
          ...
          >
            ...
            <div className="flex flex-col items-center mb-6">
              ...
              <span
                className={`mt-2 text-xs px-3 py-1 rounded-full font-semibold ${
                  ROLE_COLORS[selectedUsuario.role] || "bg-gray-100 text-gray-600"
                }`}
              >
            ...
            {/* Info */}
            <div
              className="space-y-2 text-sm mb-6 rounded-xl p-4"
              style={{ backgroundColor: "var(--bg)" }}
            >
              <p>
                <span className="font-semibold">Email:</span> {selectedUsuario.email}
              </p>
              <p>
                <span className="font-semibold">Username:</span> @{selectedUsuario.username}
              </p>
              <p>
