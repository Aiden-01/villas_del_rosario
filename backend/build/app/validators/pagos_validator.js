...
export const createPagoValidator = vine.compile(vine.object({
...
export const abonoValidator = vine.compile(vine.object({
    prestamoId: vine.number().positive().withoutDecimals().optional(),
    ventaId: vine.number().positive().withoutDecimals().optional(),
    monto: vine.number().positive(),
    fechaPago: vine.string().trim().regex(isoDate).optional(),
}));
export const programacionPagoValidator = vine.compile(vine.object({
    prestamoId: vine.number().positive().withoutDecimals().optional(),
    ventaId: vine.number().positive().withoutDecimals().optional(),
...
//# sourceMappingURL=pagos_validator.js.map