...
async function ejecutar() {
    try {
        ...
        console.log(`[CobrosNotificaciones] fecha=${resultado.fecha} encontrados=${resultado.encontrados} enviados=${resultado.enviados} omitidos=${resultado.omitidos} dryRun=${resultado.dryRun}`);
    }
    catch (error) {
...
//# sourceMappingURL=notificaciones_cobros.js.map