...
export default class DevSeedCommand extends BaseCommand {
  ...
  async run() {
    ...
    await db.rawQuery(
      'TRUNCATE TABLE pago_aplicaciones, notificaciones_cobros, programaciones_pago, pagos, venta_predios, ventas, lotes, clientes, actividades, api_tokens, users RESTART IDENTITY CASCADE;'
    )
    ...
    // Venta A: Q100,000, 20 cuotas. Pago de Q10,000 cubre 2 cuotas.
    ...
    // Venta B: Q120,000, enganche Q20,000, 20 cuotas de Q5,000.
    ...
    // Venta C: Q100,000 en 3 cuotas — prueba absorcion de centavos.
    ...
    // Venta D: Completamente pagada (Q20,000 = 2 cuotas de Q10,000).
    ...
    // Venta E: Completamente atrasada (estado vencido, sin pagos).
    ...
    // Venta F: Con pago parcial (Q2,000 de cuota Q5,000).
    ...
    // Venta G: Con reprogramacion futura.
    ...
    // Venta I: Cliente desactivado, venta y pagos historicos preservados.
